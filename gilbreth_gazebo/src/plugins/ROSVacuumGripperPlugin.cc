...
#include <ros/ros.h>
#include <sdf/sdf.hh>
#include "gilbreth_gazebo/plugins/ROSVacuumGripperPlugin.hh"
    ...
    sdf::ElementPtr _sdf)
{
  ...
  this->dataPtr->statePub = this->dataPtr->rosnode->advertise<
    gilbreth_gazebo::VacuumGripperState>(stateTopic, 1000);
}
...
bool ROSVacuumGripperPlugin::OnGripperControl(
  gilbreth_gazebo::VacuumGripperControl::Request &_req,
  gilbreth_gazebo::VacuumGripperControl::Response &_res)
{
...
{
  gilbreth_gazebo::VacuumGripperState msg;
